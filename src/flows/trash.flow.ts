...
// const flowFormIa = addKeyword(EVENTS.ACTION)
//     .addAnswer(
//         'Puedes responder todas estas preguntas en un sólo mensaje',
//         { capture: true },
//         async (ctx, { state, extensions, flowDynamic, gotoFlow }) => {
...
//                 const systemContent = POOL_CONSTRUCTION_PROMPT(infoCustomer, JSON.stringify(preguntas), JSON.stringify(preguntas_respondidas));
